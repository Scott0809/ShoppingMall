package com.bobo.shoppingmall.community.adapter;
...
import com.bobo.shoppingmall.utils.BitmapUtils;
...
public class HotPostListViewAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        String url = BASE_URL_IMAGE + resultBean.getAvatar();
//        Glide.with(mContext).load(url).transform(new BitmapTransformation(mContext) {
//            @Override
