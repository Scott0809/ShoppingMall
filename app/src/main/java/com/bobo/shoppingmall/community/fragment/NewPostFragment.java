...
import com.bobo.shoppingmall.community.adapter.NewPostListViewAdapter;
import com.bobo.shoppingmall.community.bean.NewPostBean;
    ...
    private void setPullToRefres(){
        ...
        mPtrFrame.setPtrHandler(new PtrHandler() {
            ...
            public boolean checkCanDoRefresh(PtrFrameLayout frame, View content, View header) {
                ...
                //根据自身的情况修改后
                return PtrDefaultHandler.checkContentCanBePulledDown(frame,lv_new_post, header);
            }
        });
    }
}
